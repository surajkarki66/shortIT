...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (yield newUser.comparePassword(password)) {
            ...
            if (rememberMe) {
                options = Object.assign(Object.assign({}, options), { maxAge: Number(config_1.default.jwtExpiresNum) });
...
const forgotPassword = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield User_1.default.findByEmail(email);
        if (user) {
            const transporter = yield nodemailer_1.default();
            const { _id, role } = user;
            const payload = { _id: _id.toString(), role: role };
